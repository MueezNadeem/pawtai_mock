...
class ActivityGroupItem extends StatefulWidget {
  const ActivityGroupItem({super.key});

  @override
  State<ActivityGroupItem> createState() => _ActivityGroupItemState();
}

class _ActivityGroupItemState extends State<ActivityGroupItem> {
